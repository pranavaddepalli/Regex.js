...
button.onclick = function() {
  var text = button.form.formText.value;
  var pattern = button.form.formRegex.value;
  
  var matchResult = regexEngine(pattern, text);
  
  if(matchResult){
  	document.getElementById("matchFound").hidden = false;
    document.getElementById("noMatchFound").hidden = true;

  }
  else{
  	document.getElementById("matchFound").hidden = true;
    document.getElementById("noMatchFound").hidden = false;
